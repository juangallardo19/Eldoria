...
| MTN10 | 🔧 En progreso | Sala del Boss — arena horizontal amplia. Sin cielo. Fondo MTN10.png (scale=6.5). Paredes x=±65, suelo y=-12, fosa de cristales y=-20. Techo orgánico EdgeCollider2D (domo 13 puntos, pico y=+22 en centro). FollowBounded boundsMin=(-60,-10) boundsMax=(60,+16). SteppedCameraBounds 4 pasos: x=-65(yMax=+8), x=-20(yMax=+16), x=+20(yMax=+16), x=+65(yMax=+8). 4 plataformas OneWay: Plat_Left(-42,-3,w22), Plat_Right(+40,0,w20), Plat_CenterL(-15,-7,w14), Plat_CenterR(+15,-7,w14). CrystalHazard_Pit(0,-19) + CrystalRespawnManager. SceneBoundary_Right(x=+64)→PreMTN10(spawnId="mtn10_exit"). SceneBoundary_Left(x=-64)→MTN11(spawnId="mtn10_left"). SpawnPoint "premtn10_right"(+58,-10) ← entrada desde PreMTN10. SpawnPoint "mtn11_exit"(-55,-10) ← retorno desde MTN11. Menú `Eldoria/Setup MTN10 (Boss Arena)`. |
