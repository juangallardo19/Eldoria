...
| MTN09 | 🔧 En progreso | Antesala del Boss — cueva oscura en domo con Santuario de Ara al centro. Sin cielo. Fondo MTN09.png (scale=6.5). Paredes x=±52. Suelo escalonado EdgeCollider2D: (-52,-12)→(-12,-12)→(-12,-10)→(52,-10) (entrada izquierda 2u más baja). Techo domo EdgeCollider2D (11 puntos, pico y=+15 en centro). FollowBounded boundsMin=(-50,-20), boundsMax=(50,16). SanctuaryAra en (0,-7): llama azul, glow, prompt "Descansar". CrystalHazard_Bottom en (0,-19): zona de muerte al fondo. 5 plataformas OneWay: Plat_UpperLeft(-28,-2,w22), Plat_UpperRight(32,-3,w22), Plat_SanctuaryStep(0,-8.5,w12), Plat_MidLeft(-20,-6,w14), Plat_MidRight(20,-6,w14). SceneBoundary IZQUIERDA(x=-48)→MTN08(spawnId="mtn09_exit"). SceneBoundary_Bottom(pos=0,y=-14,col=10×1)→**PreMTN10**(spawnId="mtn09_bottom"). SpawnPoint "mtn08_right"(x=-44,y=-10), "premtn10_exit"(x=0,y=-11). Menú `Eldoria/Setup MTN09`. Build Index=20. |
| MTN10 | 🔧 En progreso | Sala del Boss — arena horizontal amplia. Sin cielo. Fondo MTN10.png (scale=6.5). Paredes x=±65, suelo y=-12, fosa de cristales y=-20. Techo orgánico EdgeCollider2D (domo 13 puntos, pico y=+22 en centro). FollowBounded boundsMin=(-60,-10) boundsMax=(60,+16). SteppedCameraBounds 4 pasos: x=-65(yMax=+8), x=-20(yMax=+16), x=+20(yMax=+16), x=+65(yMax=+8). 4 plataformas OneWay: Plat_Left(-42,-3,w22), Plat_Right(+40,0,w20), Plat_CenterL(-15,-7,w14), Plat_CenterR(+15,-7,w14). CrystalHazard_Pit(0,-19) + CrystalRespawnManager. SceneBoundary_Right(x=+64)→PreMTN10(spawnId="mtn10_exit"). SceneBoundary_Left(x=-64)→PreMTN11(spawnId="mtn10_left"). SpawnPoint "premtn10_right"(+58,-10) ← entrada desde PreMTN10. SpawnPoint "mtn11_exit"(-55,-10) ← retorno desde PreMTN11. Menú `Eldoria/Setup MTN10 (Boss Arena)`. |
| PreMTN10 | 🔧 En progreso | Pasillo pre-boss en L invertida. Sin cielo. Fondo PreMTN10.png (scale=6.5, asignar en Inspector). Layout: corredor horizontal x∈[-48,+8] y∈[-21,+1]; pozo vertical x∈[+8,+45] y∈[-21,+27]. FollowBounded boundsMin=(-47,-15) boundsMax=(43,21). SteppedCameraBounds 4 pasos: x=-48(yMin=-15,yMax=-5), x=4(yMin=-15,yMax=-5), x=8(yMin=-15,yMax=+21), x=45(yMin=-15,yMax=+21). 3 plataformas OneWay en el pozo: Plat_Shaft_Low(+17,+3,w12), Plat_Shaft_Mid(+33,+12,w14), Plat_Shaft_High(+17,+21,w12). CrystalHazard_Floor(-18,-20) + CrystalRespawnManager. **Flujo: entra por arriba** SceneBoundary_Top(y=+26,w=35)→MTN09(spawnId="premtn10_exit"). **Sale por izquierda** SceneBoundary_Left(x=-47,h=24)→MTN10(spawnId="premtn10_right"). SpawnPoint "mtn09_bottom"(+26,+23) ← spawn al entrar desde MTN09. SpawnPoint "mtn10_exit"(-42,-19) ← spawn al volver desde MTN10. |
| PreMTN11 | 🔧 En progreso | Pasillo horizontal de Dash entre MTN10 (derecha) y MTN11 (izquierda). Sin cielo. Fondo PreMTN11.png (1536×1024, scale=6.5, pos=(0,-3)). x=[-50,+50], y=[-12,+6]. FollowBounded boundsMin=(-45,-12) boundsMax=(+45,+4). SceneBoundary_Right(x=+49)→MTN10(spawnId="mtn11_exit"). SceneBoundary_Left(x=-49)→MTN11(spawnId="premtn11_right"). SpawnPoint "mtn10_left"(+44,-10.5) ← desde MTN10. SpawnPoint "mtn11_right"(-44,-10.5) ← desde MTN11. WorldMapController: PreMTN11→MTN11 (zona mapa). Menú `Eldoria/Setup PreMTN11`. |
| MTN11 | 🔧 En progreso | L-shape: pozo vertical izquierda (x=[-40,0], y=[-14,+57]) + corredor horizontal base-derecha (x=[0,+54], y=[-14,+9]). Sin cielo. Fondo MTN11SinPlataformas.png (1448×1086, scale=6.5, pos=(+7,+21)). FollowBounded boundsMin=(-38,-12) boundsMax=(+52,+48). SteppedCameraBounds 4 pasos: x=-40(yMax=+48), x=-5(yMax=+48), x=+10(yMax=+7), x=+54(yMax=+7). SceneBoundary_Right(x=+53,corredor)→PreMTN11(spawnId="mtn11_right"). SceneBoundary_Top(pos=-20,y=+57,w=20)→MTN12(spawnId="mtn11_top"). SpawnPoint "premtn11_right"(+48,-11) ← desde PreMTN11. SpawnPoint "mtn12_bottom"(-20,+53) ← desde MTN12 (arco superior). Menú `Eldoria/Setup MTN11`. |
| MTN12 | 🔧 En progreso | Cueva final: techo orgánico que baja de izquierda (y=+34) a derecha (y=+12). Suelo de cristales peligrosos. Sin cielo. Fondo MTN12.png (1448×1086, scale=6.5, pos=(0,+21)). Cave x=[-33,+44], y=-14 suelo. Balcón superior-izq: Ledge y=+28, x=[-33,-18], techo nicho y=+34 → entrada desde MTN11. Arco pared derecha: y=+4 a y=+12 → salida a PreMTN12 (placeholder). Ceiling EdgeCollider2D 7 puntos ((-33,+34)→(+44,+12)). CrystalHazard_Floor + CrystalRespawnManager. **Cámara FitRoom fija**: pos=(+5.5,+10,-10), orthoSize=24 (cubre 77u×48u sin scroll). Sin SteppedCameraBounds. SceneBoundary_MTN11(pared izq, y=+28–+34)→MTN11(spawnId="mtn12_bottom"). SceneBoundary_Right(arco,x=+43,y=+8)→PreMTN12(spawnId="mtn12_right"). SpawnPoint "mtn11_top"(-24,+31) ← desde MTN11. SpawnPoint "premtn12_exit"(+38,+10) ← desde PreMTN12. Menú `Eldoria/Setup MTN12`. |
...
| `BossObsesion.cs` | State Machine + Strategy | Boss de la Obsesión. Fases: Dormant→Waking→Phase1→Phase2(buff)→Phase3→Dead. Strategy de ataques obsesivos (_lastAttack + _repeatCount: repite el mismo ataque 2/3/4 veces por fase). Daño: -1 vida (melee/range/boomerang), -2 vidas (spincharge/super). Implementa IDamageable. Detecta jugador en rango 25u. Eventos estáticos: OnHealthChanged, OnPhaseChanged, OnBossDead. |
| `BossObsesionAnimator.cs` | Observer | Bridge con Animator. Play(stateName) directo. Centraliza duraciones de clips. |
| `BossAttackHitbox.cs` | Command | Trigger activado/desactivado por BossObsesion. Llama CrystalRespawnManager.TakeBossDamage(). Solo golpea una vez por activación. |
| `BossProjectile.cs` | — | Proyectil del range attack. Vuela horizontalmente, -1 vida al tocar jugador. |
| `BossBoomerang.cs` | — | Boomerang: va y regresa al origen. -1 vida al tocar jugador. |
| `BossHealthBar.cs` | Observer | UI barra de vida del boss. Se crea programáticamente. Suscripción en Awake (no OnEnable). Barra fantasma + colores por fase (rojo/naranja/amarillo). |
| `CrystalRespawnManager.cs` | Singleton + Observer + State | Singleton local de escena. `Update` rastrea `IsGrounded` → `_lastSafePos`. `TriggerHazard()` → -1 vida. `TakeBossDamage(int)` → -N vidas (respeta _isBlinking). A 0 vidas: si PlayerPrefs "SanctuaryScene" existe → restaura 5 vidas y carga santuario con posición override; si no → MTN01_Exterior(default). `RestoreLives()` para SanctuaryFlame. **Eventos estáticos Observer:** `OnLivesChanged(int)`, `OnDamageTaken(int,int)`, `OnLivesRestored(int)` → consumen PlayerHUD. |
| `PlayerHUDConfig.cs` | — | ScriptableObject en `Assets/Resources/PlayerHUDConfig.asset`. Arrays: `araIdle/araDamage/araLow/araDeath/araHeal` (4 sprites c/u), `kaelIdle` (10 sprites). Menú `Eldoria/Setup Player HUD` para crear y rellenar. |
| `PlayerHUD.cs` | Singleton + Observer + State Machine | HUD de vida DontDestroyOnLoad. Se oculta en MainMenu/Settings/SlotsScreen/Intro. Retrato animado de Kael (zoom cara, 2× escala, pivot top, RectMask2D) + 5 AraIcon (State: Idle→Damage→Low→Death→Dead). La vida perdida más a la derecha dispara la secuencia de muerte. Bootstrap: `[RuntimeInitializeOnLoadMethod(AfterSceneLoad)]`. Canvas sortingOrder=50. |
